...
urlpatterns = patterns('',
    ...
    url(r'^Iniciar/clase$', 'Clases.views.iniciar_clase', name='iniciar_clase'),
    url(r'^Iniciar/clase/(\d+)/$','Clases.views.iniciar_clase'),
    url(r'^Estudiante$', 'Clases.views.estudiante', name='estudiante'),
    url(r'^Administrador$', 'Clases.views.administrador', name='administrador'),
    ...
    url(r'^crear/curso$', 'Clases.views.crear_curso', name='crear_curso'),
